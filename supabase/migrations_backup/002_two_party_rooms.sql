-- Two-Party Collaboration Rooms Schema
...
-- Create room_messages table for collaboration chat
...
-- Create room_invoices table to track shared invoices
...
CREATE INDEX idx_collaboration_rooms_invite_code ON collaboration_rooms(invite_code);
CREATE INDEX idx_collaboration_rooms_workspace ON collaboration_rooms(workspace_id);
CREATE INDEX idx_room_participants_room ON room_participants(room_id);
CREATE INDEX idx_room_participants_user ON room_participants(user_id);
CREATE INDEX idx_room_messages_room ON room_messages(room_id);
CREATE INDEX idx_room_invoices_room ON room_invoices(room_id);
...
-- Function to check if room is full (2 participants max)
